...
error_mapping = {
        ...
        0x0800: error("eError_AutoResetFailed", "Stromfehler", "Auto Wiederzuschaltung hat nicht funktioniert (keine weiteren Zuschaltversuche)", "Auto-Reset fehlerhaft"),
        ...
        0x4000: error("eError_OverTemp", "Temperaturfehler", "Akku obere Temperaturgrenze überschritten (Abschaltung)", "Ladetemperatur zu hoch"),
